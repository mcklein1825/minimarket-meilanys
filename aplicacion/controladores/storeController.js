...
export default class StoreController {
  ...
  async handleAuthSubmit(event) {
    ...
    const identifier = this.view.elements.authIdentifier.value;
  ...
  toggleAuthMode() {
    ...
    toggleBtn.textContent = isLogin ? 'Ya tengo cuenta' : 'Crear una cuenta';
    this.view.showToast(isLogin ? 'Funcionalidad de registro en construcción' : 'Puedes iniciar sesión con usuarios de prueba');
  }
