...
export default class StoreController {
  ...
  renderEverything() {
    ...
    if (currentUser && typeof this.model.fetchOrderHistory === 'function') {
      this.model.fetchOrderHistory()
        .then((orders) => this.view.renderHistoryModal(orders, this.model.fmt.bind(this.model)))
  ...
  openHistoryIfLoggedIn() {
    ...
    this.view.renderHistoryModal([], this.model.fmt.bind(this.model));
    this.model.fetchOrderHistory()
      .then((orders) => this.view.renderHistoryModal(orders, this.model.fmt.bind(this.model)))
      .catch((error) => {
        console.error('Error cargando historial:', error);
        this.view.showToast('No se pudo cargar tu historial');
      });
