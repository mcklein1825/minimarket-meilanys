...
(function(){
  ...
  document.getElementById('authForm').addEventListener('submit', e => {
    e.preventDefault();
    // If the modern module is active, defer to it (avoids duplicate handling)
    if (window.__storeController) return;
  ...
  document.getElementById('authToggleMode').addEventListener('click', () => {
    // If module controller exists, delegate to it
    if (window.__storeController) { window.__storeController.toggleAuthMode(); return; }
